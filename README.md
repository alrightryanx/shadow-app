# ShadowAI - The Ultimate AI Orchestrator
...
3.  **[shadow-web](https://github.com/alrightryanx/shadow-web) (Web Dashboard)**: The web core. A high-performance backend managing cloud integrations, usage tracking, unified memory, and multi-agent team coordination.
